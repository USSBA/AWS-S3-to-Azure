# AWS-S3-to-Azure
This Node.js code is used to take objects written to AWS S3 bucket and push the object's content to an SNS topic. SNS topic points to an Azure HTTP listener.
